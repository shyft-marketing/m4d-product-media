jQuery(function ($) {
    ...
    var m4dMainSwiperEl = $('.m4d-main-swiper');
    var m4dThumbSwiperEl = $('.m4d-thumb-swiper');
    var $mainWrapper = m4dMainSwiperEl.find('.swiper-wrapper');
    var $thumbWrapper = m4dThumbSwiperEl.find('.swiper-wrapper');
    ...
    var thumbPaginationEl = m4dThumbSwiperEl.find('.swiper-pagination').get(0);
    var mainNextEl = m4dMainSwiperEl.find('.swiper-button-next').get(0);
    var mainPrevEl = m4dMainSwiperEl.find('.swiper-button-prev').get(0);
    ...
    var thumbSwiper = new Swiper(m4dThumbSwiperEl.get(0), {
        slidesPerView: 6,
    ...
    var mainSwiper = new Swiper(m4dMainSwiperEl.get(0), {
    ...
    m4dThumbSwiperEl.on('click', '.swiper-slide', function () {
